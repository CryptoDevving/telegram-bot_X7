...
async def auto_click_me(context: ContextTypes.DEFAULT_TYPE) -> None:
...
async def auto_click_me_function(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    global CURRENT_BUTTON_DATA, FIRST_USER_CLICKED
...
if __name__ == "__main__":
    ...
    ## AUTO ##
    application.add_handler(CallbackQueryHandler(auto_click_me))
