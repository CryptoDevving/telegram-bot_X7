...
async def splitters(update: Update, context):
    ...
    if len(context.args) > 1:
        ...
        if chain in chain_mappings:
            ...
            await update.message.reply_text(f"For example of splitter allocation use\n`/splitter [chain-name] [amount]`", parse_mode="Markdown")
    else:
        chain = "eth"
        if chain in chain_mappings:
            chain_name, chain_url, chain_native = chain_mappings[chain]
...
async def x7dao(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chain == "":
        chain = "eth"
    chain_mappings = {
        "eth": ("(ETH)", url.ether_token, url.dex_tools_eth, ca.x7dao_pair_eth,
                url.xchange_buy_eth, "Etherscan", "eth" ),
        "arb": ("(ARB)", url.arb_token, url.dex_tools_arb, ca.x7dao_pair_arb,
                url.xchange_buy_arb, "Arbscan", "eth" ),
        "poly": ("(POLYGON)", url.poly_token, url.dex_tools_poly, ca.x7dao_pair_poly,
                 url.xchange_buy_poly, "Polygonscan", "matic" ),
        "bsc": ("(BSC)", url.bsc_token, url.dex_tools_bsc, ca.x7dao_pair_bsc,
                url.xchange_buy_bsc, "BSCscan", "bnb" ),
        "opti": ("(OP)", url.opti_token, url.dex_tools_opti, ca.x7dao_pair_opti,
                 url.xchange_buy_opti, "Optimismscan", "eth" ),
    }
    ...
    await update.message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text=chain_scan, url=f"{chain_url}{ca.x7dao}"
                    )
                ],
                [
                    InlineKeyboardButton(
                        text="Chart", url=f"{chain_dext}{chain_pair}"
                    )
                ],
                [
                    InlineKeyboardButton(
                        text="Buy", url=f"{chain_xchange}{ca.x7dao}"
                    )
                ],
            ]
        ),
...
async def x7r(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chain == "":
        chain = "eth"
    chain_mappings = {
        "eth": ("(ETH)", url.ether_token, url.dex_tools_eth, ca.x7r_pair_eth,
                url.xchange_buy_eth, "Etherscan", "eth" ),
        "arb": ("(ARB)", url.arb_token, url.dex_tools_arb, ca.x7r_pair_arb,
                url.xchange_buy_arb, "Arbscan", "eth" ),
        "poly": ("(POLYGON)", url.poly_token, url.dex_tools_poly, ca.x7r_pair_poly,
                 url.xchange_buy_poly, "Polygonscan", "matic" ),
        "bsc": ("(BSC)", url.bsc_token, url.dex_tools_bsc, ca.x7r_pair_bsc,
                url.xchange_buy_bsc, "BSCscan", "bnb" ),
        "opti": ("(OP)", url.opti_token, url.dex_tools_opti, ca.x7r_pair_opti,
                 url.xchange_buy_opti, "Optimismscan", "eth" ),
    }
    ...
    await update.message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text=chain_scan, url=f"{chain_url}{ca.x7r}"
                    )
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        text="Buy", url=f"{chain_xchange}{ca.x7r}"
                    )
                ],
            ]
        ),
...
async def x7101(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chain == "":
        chain = "eth"
    chain_mappings = {
        "eth": ("(ETH)", url.ether_token, url.dex_tools_eth, ca.x7101_pair_eth,
                url.xchange_buy_eth, "Etherscan", "eth" ),
        "arb": ("(ARB)", url.arb_token, url.dex_tools_arb, ca.x7101_pair_arb,
                url.xchange_buy_arb, "Arbscan", "eth" ),
        "poly": ("(POLYGON)", url.poly_token, url.dex_tools_poly, ca.x7101_pair_poly,
                 url.xchange_buy_poly, "Polygonscan", "matic" ),
        "bsc": ("(BSC)", url.bsc_token, url.dex_tools_bsc, ca.x7101_pair_bsc,
                url.xchange_buy_bsc, "BSCscan", "bnb" ),
        "opti": ("(OP)", url.opti_token, url.dex_tools_opti, ca.x7101_pair_opti,
                 url.xchange_buy_opti, "Optimismscan", "eth" ),
    }
    ...
    await update.message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text=chain_scan, url=f"{chain_url}{ca.x7101}"
                    )
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        text="Buy", url=f"{chain_xchange}{ca.x7101}"
                    )
                ],
            ]
        ),
...
async def x7102(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chain == "":
        chain = "eth"
    chain_mappings = {
        "eth": ("(ETH)", url.ether_token, url.dex_tools_eth, ca.x7102_pair_eth,
                url.xchange_buy_eth, "Etherscan", "eth" ),
        "arb": ("(ARB)", url.arb_token, url.dex_tools_arb, ca.x7102_pair_arb,
                url.xchange_buy_arb, "Arbscan", "eth" ),
        "poly": ("(POLYGON)", url.poly_token, url.dex_tools_poly, ca.x7102_pair_poly,
                 url.xchange_buy_poly, "Polygonscan", "matic" ),
        "bsc": ("(BSC)", url.bsc_token, url.dex_tools_bsc, ca.x7102_pair_bsc,
                url.xchange_buy_bsc, "BSCscan", "bnb" ),
        "opti": ("(OP)", url.opti_token, url.dex_tools_opti, ca.x7102_pair_opti,
                 url.xchange_buy_opti, "Optimismscan", "eth" ),
    }
    ...
    await update.message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text=chain_scan, url=f"{chain_url}{ca.x7102}"
                    )
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        text="Buy", url=f"{chain_xchange}{ca.x7102}"
                    )
                ],
            ]
        ),
...
async def x7103(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chain == "":
        chain = "eth"
    chain_mappings = {
        "eth": ("(ETH)", url.ether_token, url.dex_tools_eth, ca.x7103_pair_eth,
                url.xchange_buy_eth, "Etherscan", "eth" ),
        "arb": ("(ARB)", url.arb_token, url.dex_tools_arb, ca.x7103_pair_arb,
                url.xchange_buy_arb, "Arbscan", "eth" ),
        "poly": ("(POLYGON)", url.poly_token, url.dex_tools_poly, ca.x7103_pair_poly,
                 url.xchange_buy_poly, "Polygonscan", "matic" ),
        "bsc": ("(BSC)", url.bsc_token, url.dex_tools_bsc, ca.x7103_pair_bsc,
                url.xchange_buy_bsc, "BSCscan", "bnb" ),
        "opti": ("(OP)", url.opti_token, url.dex_tools_opti, ca.x7103_pair_opti,
                 url.xchange_buy_opti, "Optimismscan", "eth" ),
    }
    ...
    try:
        ...
        x7103_weth_dollar = float(x7103_weth) * float(api.get_native_price(chain_native))
    ...
    await update.message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text=chain_scan, url=f"{chain_url}{ca.x7103}"
                    )
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        text="Buy", url=f"{chain_xchange}{ca.x7103}"
                    )
                ],
            ]
        ),
...
async def x7104(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chain == "":
        chain = "eth"
    chain_mappings = {
        "eth": ("(ETH)", url.ether_token, url.dex_tools_eth, ca.x7104_pair_eth,
                url.xchange_buy_eth, "Etherscan", "eth" ),
        "arb": ("(ARB)", url.arb_token, url.dex_tools_arb, ca.x7104_pair_arb,
                url.xchange_buy_arb, "Arbscan", "eth" ),
        "poly": ("(POLYGON)", url.poly_token, url.dex_tools_poly, ca.x7104_pair_poly,
                 url.xchange_buy_poly, "Polygonscan", "matic" ),
        "bsc": ("(BSC)", url.bsc_token, url.dex_tools_bsc, ca.x7104_pair_bsc,
                url.xchange_buy_bsc, "BSCscan", "bnb" ),
        "opti": ("(OP)", url.opti_token, url.dex_tools_opti, ca.x7104_pair_opti,
                 url.xchange_buy_opti, "Optimismscan", "eth" ),
    }
    ...
    try:
        ...
        x7104_weth_dollar = float(x7104_weth) * float(api.get_native_price(chain_native))
    ...
    await update.message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text=chain_scan, url=f"{chain_url}{ca.x7104}"
                    )
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        text="Buy", url=f"{chain_xchange}{ca.x7104}"
                    )
                ],
            ]
        ),
...
async def x7105(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chain == "":
        chain = "eth"
    chain_mappings = {
        "eth": ("(ETH)", url.ether_token, url.dex_tools_eth, ca.x7105_pair_eth,
                url.xchange_buy_eth, "Etherscan", "eth" ),
        "arb": ("(ARB)", url.arb_token, url.dex_tools_arb, ca.x7105_pair_arb,
                url.xchange_buy_arb, "Arbscan", "eth" ),
        "poly": ("(POLYGON)", url.poly_token, url.dex_tools_poly, ca.x7105_pair_poly,
                 url.xchange_buy_poly, "Polygonscan", "matic" ),
        "bsc": ("(BSC)", url.bsc_token, url.dex_tools_bsc, ca.x7105_pair_bsc,
                url.xchange_buy_bsc, "BSCscan", "bnb" ),
        "opti": ("(OP)", url.opti_token, url.dex_tools_opti, ca.x7105_pair_opti,
                 url.xchange_buy_opti, "Optimismscan", "eth" ),
    }
    ...
    try:
        ...
        x7105_weth_dollar = float(x7105_weth) * float(api.get_native_price(chain_native))
    ...
    await update.message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text=chain_scan, url=f"{chain_url}{ca.x7105}"
                    )
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        text="Buy", url=f"{chain_xchange}{ca.x7105}"
                    )
                ],
            ]
        ),
