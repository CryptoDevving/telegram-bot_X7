                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url=f"{urls.XCHANGE_BUY_OPTI}{token_address}",
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Chart",
                            url=f"{urls.DEX_TOOLS_OPTI}{event['args']['pair']}",
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Token Contract",
                            url=f"{urls.OPTI_ADDRESS}{token_address}",
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Deployer TX",
                            url=f"{urls.OPTI_TX}{event['transactionHash'].hex()}",
                        )
                    ],
                ]
            ),
