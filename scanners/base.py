                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url=f"{urls.XCHANGE_BUY_BASE}{token_address}",
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Chart",
                            url=f"{urls.DEX_TOOLS_BASE}{event['args']['pair']}",
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Token Contract",
                            url=f"{urls.BASE_ADDRESS}{token_address}",
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            text="Deployer TX",
                            url=f"{urls.BASE_TX}{event['transactionHash'].hex()}",
                        )
                    ],
                ]
            ),
