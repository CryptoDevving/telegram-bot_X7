...
CONTRACT_MAPPINGS = {
    ...
    "X7D": (("setAuthorizedMinter\n"
             "setAuthorizedRedeemer\n"
             "setRecoveredTokenRecipient\n"
             "setRecoveredETHRecipient"
             ), ca.X7D),
    "Ecosystem Splitter": (("setWETH\n"
                            "setOutlet\n"
                            "freezeOutletChange\n"
                            "setShares\n"
                            ), ca.ECO_SPLITTER),
    "Treasury Splitter": (("freezeOutlet\n"
                           "setOutletRecipient\n"
                           "setSlotShares"
    ...
    "Borrowing Maxi": (("setMintFeeDestination\n"
                        "setBaseURI\n"
                        "setMintPrice"
                        ), ca.BORROW),
    "DEX Maxi": (("setMintFeeDestination\n"
                  "setBaseURI\n"
                  "setMintPrice"
                  ), ca.DEX),
    "Ecosystem Maxi": (("setMintFeeDestination\n"
                        "setBaseURI\n"
                        "setMintPrice"
                        ), ca.ECO),
    "Liquidity Maxi": (("setMintFeeDestination\n"
                        "setBaseURI\n"
                        "setMintPrice"
                        ), ca.LIQ),
    "Magister": (("setMintFeeDestination\n"
                  "setBaseURI\n"
                  "setMintPrice"
                  ), ca.MAGISTER),
    "Pioneer": (("setTransferUnlockFeeDestination\n"
                 "setBaseURI\n"
                 "setTransferUnlockFee\n"
                 "SetAllowTokenOwnerVariantSelection"
                 ), ca.PIONEER),
    "Lending Pool": (("setEcosystemRecipientAddress\n"
                      "setRouter\n"
                      "setWETH\n"
                      "setX7D\n"
    ...
    "Lending Pool Reserve": (("setLendingPool\n"
    ...
    "Loans": (("setLoanAuthority\n"
               "setBaseURI\n"
               "setUseBaseURIOnly\n"
               "setLoanLengthLimits\n"
               "setLoanAmountLimits"
               ), ca.ILL001),
    "Token Time Lock": (("setWETH\n"
    ...
    "X7100 Discount Authority": (("setEcosystemMaxiNFT\n"
                                  "setLiquidityMaxiNFT\n"
                                  "setMagisterNFT\n"
                                  "setX7DAO\n"
                                  ), ca.X7100_DISCOUNT),
    "X7DAO Discount Authority": (("setEcosystemMaxiNFT\n"
                                  "setLiquidityMaxiNFT\n"
                                  ), ca.X7DAO_DISCOUNT),
    "X7R Discount Authority": (("setEcosystemMaxiNFT\n"
                                "setLiquidityMaxiNFT\n"
                                "setMagisterNFT\n"
                                ), ca.X7R_DISCOUNT),
    "Lending Discount Authority": (("setAuthorizedConsumer\n"
    ...
    "Xchange Discount Authority": (("setDEXMaxiNFT"
                                    ), ca.XCHANGE_DISCOUNT),
}
