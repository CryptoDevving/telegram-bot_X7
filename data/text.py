...
commands = (
    ...
    "/joke - Daily Joke\n"
    "/launch - X7 Finance Launch Date Info\n"
    "/leaderboard - Fastest Pioneer Leaderboard\n"
...
emoji_combinations = [
    ...
    {"emojis": "🪑+⬆️", "answer": "Cheer up"},
    {"emojis": "🏠+🍭 🍬 🍫+🏠", "answer": "Home sweet home"},
    {"emojis": "☝🏼+🔵+🌙", "answer": "Once in a blue moon"},
    {"emojis": "🦶+⚽️ 🏀+🎮", "answer": "Football game"},
    {"emojis": "😡+⛽️+🚗", "answer": "Madagascar"},
    {"emojis": "🍯+🌖", "answer": "Honeymoon"},
    {"emojis": "🏰 + 🌃", "answer": "Fortnite"},
    {"emojis": "🐀👨🏻‍🍳 + 🍳🇫🇷", "answer": "Ratatouille"},
    {"emojis": "👑+🐝", "answer": "Queen bee"},
    {"emojis": "🍕🍕🍕🍕", "answer": "Four cheese pizza"},
    {"emojis": "🐻🧸", "answer": "Teddy bear"},
    {"emojis": "🌍+🥛", "answer": "World Cup"},
    {"emojis": "🎨+🖌️", "answer": "Paint brush"},
    {"emojis": "🚪+🚶‍♀️", "answer": "Door step"},
    {"emojis": "🎃👻🕸️🕷️", "answer": "Haloween"},
    {"emojis": "🐈+🦸‍♀️", "answer": "Cat woman"},
    {"emojis": " 🎭🎬🎥", "answer": "Holywood"},
    {"emojis": "🕷 🕸+🙋🏻‍♂️", "answer": "Spiderman"},
    {"emojis": "🔍+🔦", "answer": "Sherlock Holmes"},
    {"emojis": "🧩+🤝", "answer": "Pieces together"},
    {"emojis": "🔟+🇪🇪+👁", "answer": "Tennessee"},
    {"emojis": "🕰️🏅 + 🕊️ + 🐛", "answer": "The early bird catches the worm"},
    {"emojis": "👋+☀️", "answer": "Bison"},
    {"emojis": "🏰❄️👩🏻‍❤️‍👩🏼⛄️", "answer": "Frozen"},
    {"emojis": "😈+👀+👢", "answer": "The devil wears Prada"},
    {"emojis": "👶+🥶+➡️", "answer": "Baby its cold outside"},
    {"emojis": "🌕 + 👨🏻‍🦰➡️🐺", "answer": "Werewolf"},
    {"emojis": "👸🏼 +😘🐸➡️🤴🏼", "answer": "True love kiss"},
    {"emojis": "🦁+👑", "answer": "Lion king"},
    {"emojis": "🐝+↪️+🔙", "answer": "Be right back"},
    {"emojis": "❄️+🍵", "answer": "Iced tea"},
    {"emojis": "🗿 + ⭐️", "answer": "Rock star"},
    {"emojis": "👻+🏠", "answer": "Haunted house"},
    {"emojis": "🤱🚦🚣 🐝", "answer": "Margot Robbie"},
    {"emojis": "🐝🔛🌊", "answer": "Beyonce"},
    {"emojis": "🐻👧👧", "answer": "Bear Grylls"},
    {"emojis": "🎭🏆🍟", "answer": "Oprah Winfrey"},
    {"emojis": "🥤🥫🐝🥶", "answer": "Justin Beiber"},
    {"emojis": "📅📹🥓", "answer": "David Beckham"},
    {"emojis": "✒️👋🅿️🛳️", "answer": "Penelope Cruz"},
    {"emojis": "🏝️🎣", "answer": "Isla Fisher"},
    {"emojis": "😩👨🐄", "answer": "Simon Cowell"},
    {"emojis": "🏹👋💇👨‍👦⛰️🦇🔟🏆🛶", "answer": "Archie Harrison Mountbatten-Windsor"},
]
